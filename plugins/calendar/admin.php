<h3 class="floated"> <?php if (isset($_GET['settings'])) {
    i18n('calendar/calendar_settings');

} else {
    i18n('calendar/calendar');
} ?></h3>
<div class="edit-nav clearfix">
    <a href="load.php?id=calendar&settings" <?php if (isset($_GET['settings'])) {
?>class="current"<?php
} ?>><?php i18n('calendar/settings'); ?></a>
    <a href="load.php?id=calendar&events" <?php if (isset($_GET['events'])) {
?>class="current"<?php
} ?>><?php i18n('calendar/events'); ?></a>
    <a href="load.php?id=calendar&calendar" <?php if (isset($_GET['calendar'])) {
?>class="current"<?php
