...
var _user$project$Constants$langsText = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'fr', _1: 'Francais'},
		_1: {
			ctor: '::',
...
var _user$project$Types$defaultTab = {
	url: '',
	title: '',
	parent: _elm_lang$core$Maybe$Just('')
};
...
var _user$project$Types$Tab = F3(
	function (a, b, c) {
		return {url: a, title: b, parent: c};
	});
...
var _user$project$JsonDecoder$decodePage = A4(
	...
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'children', _user$project$JsonDecoder$decodeTabs)));
var _user$project$JsonDecoder$decodeData = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Types$BackendData,
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'langs', _user$project$JsonDecoder$decodeLanguages)),
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'tabs', _user$project$JsonDecoder$decodeTabs)),
	A2(_elm_lang$core$Json_Decode$field, 'page', _user$project$JsonDecoder$decodePage));
...
var _user$project$Messages$RequestResult = function (a) {
...
var _user$project$Tabs$viewTab = F3(
	function (top, current, tab) {
		var fontStyle = {
			ctor: '::',
			_0: _debois$elm_mdl$Material_Options$cs('mdl-layout__tab'),
			_1: {
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'font-weight', '500'),
				_1: {
					ctor: '::',
					_0: A2(_debois$elm_mdl$Material_Options$css, 'padding', '0 20px'),
					_1: {
						ctor: '::',
						_0: A2(_debois$elm_mdl$Material_Options$css, 'line-height', '48px'),
						_1: {
							ctor: '::',
							_0: A2(_debois$elm_mdl$Material_Options$css, 'outline', 'none'),
							_1: {
								ctor: '::',
								_0: A2(_debois$elm_mdl$Material_Options$css, 'cursor', 'default'),
								_1: {ctor: '[]'}
							}
						}
					}
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_1: {
						...
						_0: A2(
							_debois$elm_mdl$Material_Options$when,
							_elm_lang$core$Native_Utils.eq(tab.url, current),
							_debois$elm_mdl$Material_Options$cs('is-active')),
						_1: {
							ctor: '::',
							_0: A2(
								_debois$elm_mdl$Material_Options$when,
								!top,
								_debois$elm_mdl$Material_Options$cs('subtab')),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$attribute(
									A2(
...
var _user$project$Tabs$viewSubTabs = F2(
	function (tabs, current) {
		return A2(
			_elm_lang$core$List$map,
			A2(_user$project$Tabs$viewTab, false, current),
			tabs);
	});
var _user$project$Tabs$view = F2(
	function (tabs, current) {
		return A2(
			_elm_lang$core$List$map,
			A2(_user$project$Tabs$viewTab, true, current),
			tabs);
	});
...
var _user$project$Main$builder2messages = function (builder) {
	...
	if (_p0.ctor === '::') {
		return {
			ctor: '::',
			_0: _user$project$Messages$ChangePage(_p0._0),
			_1: {ctor: '[]'}
		};
	} else {
		return {
			ctor: '::',
			_0: _user$project$Messages$ChangePage('index'),
			_1: {ctor: '[]'}
		};
	}
};
var _user$project$Main$url2messages = function (location) {
	return _user$project$Main$builder2messages(
		_rgrempel$elm_route_url$RouteUrl_Builder$fromUrl(location.href));
};
var _user$project$Main$delta2builder = F2(
	function (previousModel, currentModel) {
		var sitePath = _rgrempel$elm_route_url$RouteUrl_Builder$path(
			_rgrempel$elm_route_url$RouteUrl_Builder$fromUrl(currentModel.siteUrl));
		var a = A2(_elm_lang$core$Debug$log, 'path', sitePath);
		return ((!_elm_lang$core$Native_Utils.eq(previousModel.current, currentModel.current)) || (!_elm_lang$core$Native_Utils.eq(previousModel.languages.current, currentModel.languages.current))) ? _elm_lang$core$Maybe$Just(
			A2(
				_rgrempel$elm_route_url$RouteUrl_Builder$appendToPath,
				{
					ctor: '::',
					_0: currentModel.current,
					_1: {ctor: '[]'}
				},
				A2(_rgrempel$elm_route_url$RouteUrl_Builder$replacePath, sitePath, _rgrempel$elm_route_url$RouteUrl_Builder$builder))) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Main$delta2url = F2(
	function (previous, current) {
		return A2(
			_elm_lang$core$Maybe$map,
			_rgrempel$elm_route_url$RouteUrl_Builder$toUrlChange,
...
var _user$project$Main$htmlNodeToElm = function (node) {
	...
	switch (_p3.ctor) {
		...
		case 'Element':
			var children_ = _user$project$Main$htmlNodesToElm(_p3._2);
			var attrs = _user$project$Main$htmlAttributesToElm(_p3._1);
			return A3(_elm_lang$html$Html$node, _p3._0, attrs, children_);
		default:
			return _elm_lang$html$Html$text('');
	}
};
var _user$project$Main$viewSubTabs = function (model) {
	var children = model.page.children;
	var a = A2(_elm_lang$core$Debug$log, 'children', children);
	var _p4 = children;
	if (_p4.ctor === 'Nothing') {
		return {ctor: '[]'};
	} else {
		return A2(_user$project$Tabs$viewSubTabs, _p4._0, model.current);
	}
};
...
var _user$project$Main$viewBody = function (model) {
	var subnav = _user$project$Main$viewSubTabs(model);
	var page = model.page;
	var a = A2(_elm_lang$core$Debug$log, 'page', page);
									...
									_0: A2(
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$cs('elm-subnav'),
													_1: {ctor: '[]'}
												},
												subnav),
											_1: {ctor: '[]'}
															...
															_1: {
																...
																_0: _debois$elm_mdl$Material_Options$attribute(
																	A2(
																		_elm_lang$html$Html_Attributes$property,
																		'innerHTML',
																		_elm_lang$core$Json_Encode$string(page.title))),
																_1: {ctor: '[]'}
															}
														},
														{ctor: '[]'}),
	...
	if ((_p5.ctor === '::') && (_p5._1.ctor === '[]')) {
		...
		return A2(
			_debois$elm_mdl$Material_Layout$link,
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material_Options$onClick(
					_user$project$Messages$ChangeLanguage(_p6)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text(
					A2(_user$project$Main$getLanguageText, _p6, _user$project$Constants$langsText)),
				_1: {ctor: '[]'}
			});
	} else {
...
var _user$project$Main$header = function (model) {
	return {
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: A2(_debois$elm_mdl$Material_Options$css, 'height', '120px'),
				_1: {
					ctor: '::',
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('theme/clq/css/img/logo3-simple.png'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
					...
					_1: {
						...
						_0: A2(
							...
							A2(
								...
								{
									ctor: '::',
									_0: _user$project$Main$viewLanguages(model.languages),
									_1: {ctor: '[]'}
								})),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$createUrl = F2(
...
var _user$project$Main$getData = F2(
	function (siteUrl, args) {
		var args_ = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'id', _1: 'fetchdata'},
			_1: args
		};
		var url = A2(
			_user$project$Main$createUrl,
			A2(_elm_lang$core$Basics_ops['++'], siteUrl, 'index.php'),
			args_);
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Messages$RequestResult,
			A2(_elm_lang$http$Http$get, url, _user$project$JsonDecoder$decodeData));
	});
var _user$project$Main$getPageData = F2(
	function (page, model) {
		var args = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'page', _1: page},
			_1: {ctor: '[]'}
		};
...
var _user$project$Main$changeLanguage = F2(
	function (lang, model) {
		...
		var args = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'page', _1: model.current},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'setlang', _1: lang},
				_1: {ctor: '[]'}
			}
		};
		return A2(_user$project$Main$getData, model.siteUrl, args);
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p10.ctor) {
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _user$project$Messages$Mdl, _p10._0, model);
			case 'Nop':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ChangePage':
				var _p11 = _p10._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{current: _p11}),
					_1: A2(_user$project$Main$changePage, _p11, model)
				};
			case 'ChangeLanguage':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(_user$project$Main$changeLanguage, _p10._0, model)
				};
			default:
				if (_p10._0.ctor === 'Ok') {
					var _p14 = _p10._0._0;
					var one = A2(_elm_lang$core$Debug$log, 'data', _p14);
					var tabs_ = function () {
						var _p12 = _p14.tabs;
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{languages: langs, tabs: tabs_, page: _p14.page}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var one = A2(_elm_lang$core$Debug$log, 'err', _p10._0._0);
					return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
				}
		}
	});
var _user$project$Main$getInit = function (siteUrl) {
	return A2(
		...
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'page', _1: 'init'},
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$init = function (flags) {
	return {
		...
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: _debois$elm_mdl$Material$init(_user$project$Messages$Mdl),
				_1: {
					ctor: '::',
					_0: _user$project$Main$getInit(flags.siteUrl),
					_1: {ctor: '[]'}
				}
			})
	};
...
var _user$project$Main$main = _rgrempel$elm_route_url$RouteUrl$programWithFlags(
	{
		...
		location2messages: _user$project$Main$url2messages,
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'siteUrl', _elm_lang$core$Json_Decode$string)));
